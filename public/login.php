...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-center h-100" id='animar'>
            <div class="card">
                <div class="card-header">
                    <h3>Login</h3>
                </div>
                <div class="card-body">
                    <form name='login' method='POST' id='miForm' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
                        ...
                        <div class="form-group">
                            <input type="submit" value="Login" id='enviar' class="btn float-right btn-success" name='login'>
                        </div>
                    </form>
                </div>
            </div>
